...
List<Map<String, dynamic>> questions = [
  ...
  },
  {
    ...
    "choices": <String>["Fransa", "Almanya", "İspanya", "Fas"],
    "answer": "Fas"
  },
];
...
class _QuestionPageState extends State<QuestionPage> {
  ...
  Future<void> setChoices() async {
    ...
    for (int a = 0; a < (questions[currentQuestionIndex]["choices"] as List<String>).length; a++) {
      Completer<void> completer = Completer<void>();
      Stream<String> choiceStream = periodicQuestionStream(
          (questions[currentQuestionIndex]["choices"] as List<String>)[a],
  ...
  final Stream<String> questionStream = periodicQuestionStream(
      questions[0]["question"], Duration(milliseconds: 50));
  List<String> choices =
      (questions[0]["choices"] as List<String>).map((e) => "").toList();
        ...
        child: SizedBox(
          ...
          child: Column(
            ...
            children: [
              ...
              Column(
                children: [
                  for (String choice in choices) choiceButtonWidget(choice),
                ],
              ),
              SizedBox(
                height: height / 20,
              ...
              Center(
                child: SizedBox(
                  width: double.infinity,
                  height: height / 10,
                  child: clickButtonWidget(isAnswerClicked)
                ),
              )
            ],
          ),
        ...
        ElevatedButton(
          ...
          style: ElevatedButton.styleFrom(
              ...
              shape: RoundedRectangleBorder(
                  borderRadius:
                      BorderRadius.circular(Helper.CHOICE_BORDER_RADIUS))),
          child: Align(
  ...
  Widget clickButtonWidget(bool isAnswerClicked){
    if(isAnswerClicked){
